...
- (NSString *)mt_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)mt_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
            case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
            case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)mt_hmacMD5StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)mt_hmacMD5DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)mt_hmacSHA1StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)mt_hmacSHA1DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)mt_hmacSHA224StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)mt_hmacSHA224DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)mt_hmacSHA256StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)mt_hmacSHA256DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)mt_hmacSHA384StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)mt_hmacSHA384DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)mt_hmacSHA512StringWithKey:(NSString *)key {
    return [self mt_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)mt_hmacSHA512DataWithKey:(NSData *)key {
    return [self mt_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)mt_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)mt_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)mt_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)mt_dataWithBase64EncodedString:(NSString *)base64EncodedString {
...
+ (NSData *)mt_dataNamed:(NSString *)name {
