...
- (void)mt_setBorderRadius:(CGFloat)corner borderWidth:(CGFloat)width ColorString:(NSString *)color {
    ...
    CGColorRef borderColor = CGColorCreate(colorSpaceRef, (CGFloat[]){((float) r / 255.0f),((float) g / 255.0f),((float) b / 255.0f),1});
