...
@implementation UIImage (MTExtEffect)
...
- (UIImage *)mt_imageByGrayscale {
    return [self mt_imageByBlurRadius:0 tintColor:nil tintMode:0 saturation:0 maskImage:nil];
}
...
- (UIImage *)mt_imageByBlurSoft {
    return [self mt_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:0.84 alpha:0.36] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)mt_imageByBlurLight {
    return [self mt_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:1.0 alpha:0.3] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)mt_imageByBlurExtraLight {
    return [self mt_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.97 alpha:0.82] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)mt_imageByBlurDark {
    return [self mt_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.11 alpha:0.73] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)mt_imageByBlurWithTint:(UIColor *)tintColor {
    ...
    return [self mt_imageByBlurRadius:20 tintColor:effectColor tintMode:kCGBlendModeNormal saturation:-1.0 maskImage:nil];
}
