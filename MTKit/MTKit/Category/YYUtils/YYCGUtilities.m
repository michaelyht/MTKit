...
CGAffineTransform YYCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    after[0] = [from mt_convertPoint:before[0] toViewOrWindow:to];
    after[1] = [from mt_convertPoint:before[1] toViewOrWindow:to];
    after[2] = [from mt_convertPoint:before[2] toViewOrWindow:to];
