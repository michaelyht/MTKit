...
+ (UIImage *)generateNormalQRCodeOfString:(NSString *)dataString imageViewWidth:(CGFloat)imageViewWidth {
    ...
    return [self getUIImageByCIImage:outputImage withSize:imageViewWidth];
}
...
#pragma mark - private
+ (UIImage *)getUIImageByCIImage:(CIImage *)image withSize:(CGFloat)size {
